...
define( 'WPCACHEHOME', '/home3/mauibeats/labeatsdjs.com/wp-content/plugins/wp-super-cache/' );
define('WP_CACHE', true); //Added by WP-Cache Manager
define('DB_NAME', 'mauibeat_wrdp2');

/** MySQL database username */
define('DB_USER', 'mauibeat_wrdp2');

/** MySQL database password */
define('DB_PASSWORD', 'mauibeatt!@#wrdp2');
